        ...
        try {
            ...
            switch (method) {
                case METHODS.GET:
                    ...
                    break;
                case METHODS.POST:
                    handlers.handlePost(req, res, data, filePath, PRODUCTS.PRODUCTS, id);
                    break;
                case METHODS.PUT:
                    handlers.hanldePut(req, res, id, data, filePath, PRODUCTS.PRODUCTS);
                    break;
                case METHODS.PATCH:
                    handlers.handlePatch(req, res, id, data, filePath, PRODUCTS.PRODUCTS);
                    break;
                case METHODS.DELETE:
